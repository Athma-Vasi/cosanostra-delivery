...
pub fn navigator_test() {
  ...
  let assert Ok(_navigator) =
    navigator.new(navigator_name, coordinates_store_name, distances_cache_name)
  ...
  let distance =
    navigator.get_distance(navigator_subject, 56_001_962_700, 56_001_962_800)
